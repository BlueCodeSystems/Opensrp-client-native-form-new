...
public class JsonFormActivityTest extends BaseActivityTest {
    ...
    public void testGetValueFromAddressCoreForEditTexts() throws Exception {
        ...
        Facts facts = TestReflectionHelpers.invokeMethod(activity, "getValueFromAddressCore", jsonObject);
    ...
    public void testSetRadioButtonOptionsDisabled() throws Exception {
        ...
        TestReflectionHelpers.invokeMethod(activity, "setReadOnlyRadioButtonOptions", radioGroup, false);
    ...
    public void testSetRadioButtonOptionsEnabled() throws Exception {
        ...
        TestReflectionHelpers.invokeMethod(activity, "setReadOnlyRadioButtonOptions", radioGroup, true);
    ...
    public void testRefreshExpansionPanelShouldInvokeExpectedMethods() throws JSONException {
        ...
        TestReflectionHelpers.setField(activity, "formUtils", mockFormUtils);
        TestReflectionHelpers.setField(activity, "utils", mockUtils);
    ...
    public void testGetValueFromAddressReturnsNull() throws Exception {
        ...
        Facts facts = TestReflectionHelpers.invokeMethod(activity, "getValueFromAddress", address, true, jsonObject);
    ...
    public void testUpdateUIByMaterialEditText() throws Exception {
        ...
        TestReflectionHelpers.invokeMethod(activity, "updateUiByConstraints", view, true, errorMessage);
    ...
    public void testGetViewKey() throws Exception {
        ...
        Mockito.doReturn(childKey).when(view).getTag(R.id.childKey);
        Mockito.doReturn(key).when(view).getTag(R.id.key);
        String returnKey = TestReflectionHelpers.invokeMethod(jsonFormActivity, "getViewKey", view);
