...
[![Build for latest tag (v3.2.0)](https://jitpack.io/v/BlueCodeSystems/Opensrp-client-native-form-new/v3.2.0.svg)](https://jitpack.io/#BlueCodeSystems/Opensrp-client-native-form-new/v3.2.0)
...
- Current branch: `main` (checked out on September 26, 2025); latest tag: `v3.2.0`.
